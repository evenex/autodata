...
package {/*generator/compiler/linker}*/
			...
			static {/*runtime}*/
				...
				void build_program ()
					{/*...}*/
						...
						if (auto error = verify!`Program` (program_id))
							assert (0, error);
				...
				auto compile_shader (string code, Stage stage)
					{/*...}*/
						...
						if (auto error = verify!`Shader` (shader))
							{/*...}*/
	...
	private auto verify (string object_type)(GLuint gl_object)
		{/*...}*/
			GLint status;

			enum glGet_iv = q{gl.Get} ~ object_type ~ q{iv};
			enum glGet_InfoLog = q{gl.Get} ~ object_type ~ q{InfoLog};
			enum glStatus = object_type == `Shader`? `COMPILE`:`LINK`;

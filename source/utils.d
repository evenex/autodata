...
public {/*containers}*/
	template TripleBuffer (T, int sync_frequency = 4_000)
		{/*...}*/
						...
						void writer_swap ()
							{/*...}*/
								while ((write+2)%3 != read)
									core.thread.Thread.sleep (sync_cycle);
								buffer[++write %= 3].clear;
							}
						void reader_swap ()
							{/*...}*/
			...
			struct DoubleBuffer
				{/*...}*/
					...
					shared {/*ops}*/
						void swap ()
							{/*...}*/
								buffer[++select %= 2].clear;
							}
					}
					shared @property {/*...}*/
						ref T[] fore ()
							in {/*...}*/
								debug check_owner (Side.fore);
							}
							body {/*...}*/
								return (cast()this).buffer[select];
							}
						ref T[] back ()
							in {/*...}*/
								debug check_owner (Side.back);
							}
							body {/*...}*/
								return (cast()this).buffer[(select+1)%2];
							}
						ref T[] data ()
							{/*...}*/
								return fore;
					...
					debug {/*safety}*/
						import std.concurrency;
						enum Side {fore, back}
						Tid[][Side] owner_history;
						shared void check_owner (Side side)
							{/*...}*/
								if (side in owner_history)
									{/*...}*/
										auto owners = (cast()this).owner_history[side];
										if (owners.canFind (thisTid))
											assert (owners.back == thisTid,
												"accessed "~to!string(side)~" of a swap buffer owned by "
													~tid_string(owners.back));
										else (cast()this).owner_history[side] ~= thisTid;
									}
								else (cast()this).owner_history[side] = [thisTid];
							}
					}
...
public {/*metaprogramming}*/
	...
	public {/*code generation}*/
		...
		static string autodeclare (Params...)() if (Params.length > 0)
			{/*...}*/

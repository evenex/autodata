	...
	{/*...}*/
		public {/*interface}*/
			...
			void process ()
				{/*...}*/
					events.swap ();
					foreach (event; events.back) with (event) 
		...
		private:
		private {/*events}*/
			shared static Swap_Buffer!Event events;
			struct Event
				{/*...}*/
					private {/*data}*/
						int code;
			...
			void key_callback (GLFWwindow*, int key, int scancode, int state, int mods) nothrow
				{/*...}*/
					if (state == GLFW_REPEAT)
						return;
					events.data ~= Event (key, cast(bool)state);
				}
			void button_callback (GLFWwindow*, int button, int state, int mods) nothrow
				{/*...}*/
					if (state == GLFW_REPEAT)
						return;
					events.data ~= Event (button, cast(bool)state);
				}
